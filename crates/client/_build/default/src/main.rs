...
fn main() {
    ...
    // get_req(123 as u64, &mut stream);
    // // get_req(10469724552079209318 as u64, &mut stream);
...
fn push_req(stream: &mut TcpStream, value: String) -> Message {
    ...
    //     .map(char::from)
    //     .collect();
    // let value: String = format!("{}-{}", "a", value);
    // let queue_val = value.clone();
    // let print_val = value.clone();
